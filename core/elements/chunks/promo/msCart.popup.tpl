<div class="cart-popup">
    ...
    <div id="msCart">
        <div class="popup-card__list">
            <div class="popup-card">
                <div class="popup-card__remove"></div>
                <div class="popup-card__image" style="background-image: url('/assets/images/products/516/120x90/stojka-1.jpg');"></div>
                <div class="popup-card__caption">Комбинезон белый  с нанесением логотипа</div>
            </div>
            <div class="popup-card">
                <div class="popup-card__remove"></div>
                <div class="popup-card__image" style="background-image: url('/assets/images/products/516/120x90/stojka-1.jpg');"></div>
                <div class="popup-card__caption">Печать визиток</div>
            </div>
        </div>
        {if !count($products)}
    ...
    <div class="cart-popup__bottom">
        <a class="btn_rd_default fancybox" href="#"><span>ОФОРМИТЬ ЗАЯВКУ</span></a>
    </div>
</div>